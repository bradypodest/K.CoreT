...
{
    public class SysPowerService : BaseServices<SysPower>, ISysPowerService
    {
        ISysPowerRepository _dal;
        IMapper _mapper;
        IUser _httpUser;
        public SysPowerService(ISysPowerRepository dal, IMapper mapper, IUser httpUser)
        {
            this._dal = dal;
            base.baseDal = dal;
